...
if ( is_page_template( 'template-home.php' ) ){ echo '<div class="home-content">'; 
} else { ?>
	<div class="top-bar">
		<div class="container">
       <?php
            do_action( 'metro_magazine_breadcrumbs' );
        ?>
			<div class="page-header">
                <h1 class="page-title">
        			...
        			if( is_archive() ){
        		        ...
        		        esc_html_e( '404 Error - Page Not Found','metro-magazine' );
        			}elseif( is_search() ){ 
        			     printf( esc_html__( 'Search Results for: %s', 'metro-magazine' ), get_search_query() );
                    } ?>
                </h1>
			</div>
		</div>
